...
Q.scene("mainLevel", function (stage) {
    ...
    stage.insert(new Q.Powerup({x:100, y:100}));
...
Q.load(["cave_bg.png", "spaceship2.png", "shot.png", "alien2.png","heart.png","enemy.png", "explosion.png",
    "player.json", "shot.json", "powerup.json", "powerup.png", "alien.json", "enemy.json","explosion.json","boom.wav"], function () {
        //Q.debug = true;
        //Q.debugFill = true;
        ...
        Q.compileSheets("powerup.png", "powerup.json");
        ...
        Q.animations("powerup", { default: { frames: [0, 1, 2, 3, 4, 5, 6, 7], rate: 1 / 4 } });
        Q.stageScene("mainLevel");
    });